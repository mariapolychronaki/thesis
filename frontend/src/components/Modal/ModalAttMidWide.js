...
const ModalAttackingMidfielderWide = ({ closeModalAttackingMidfielderWide, closeModalPlayer,response,player }) => {
    ...
    const createAttackingMidfielderWide = async () => {
        await axios
          .post(
    ...
    const handleSubmit = () => {
        ...
        createAttackingMidfielderWide();
    }

    const handleClose1 = () => {
        setshowConfirm(false)
        closeModalAttackingMidfielderWide(false)
