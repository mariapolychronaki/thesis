...
export const Lineup = () => {
    ...
    const suggested_lineup = () => {
        ...
        if (arrayPlayerMatchRating1 !== undefined && arrayPlayerMatchRating2 !== undefined &&
            arrayPlayerTrainingRating1 !== undefined
            && arrayPlayerTrainingRating2 !== undefined && arrayPlayerTrainingRating3 !== undefined &&
            arrayPlayerTrainingRating4 !== undefined &&
            arrayPlayerTrainingRating5 !== undefined) {
            ...
            {!openModalInjured && formation_4231 &&
                <div className='container-fluid'>
                    ...
                    <div class="col-6 pitch">
                        ...
                        <div className='col-12 midfielders'>
                        ...
                        <div className='col-12 goalkeeper'>
                            <div className='offset-4 col-4'>
...

            {
                ...
                <div className='container-fluid '>
                    ...
                    <div class="col-6 pitch">
                        ...
                        <div className='col-12 forward4_3_3'>
                            <div className='offset-4 col-4'>
                                <Player player={best_for1} />
                            </div>
                        </div>
                        ...
                        <div className='col-12 Att_mid4_3_3'>
                        ...
                        <div className='col-12 midfielders4_3_3'>
                            <div className='offset-3 col-3 '>
                                <Player player={best_Midfielder2} />
                            </div>
                            <div className='col-3'>
                        ...
                        <div className='spacelineup1'></div>

                        <div className='col-12 defensive_Mid_4_3_3'>
                        ...
                        <div className='col-12 defenders4_3_3'>
                            <div className='col-3'>
                                <Player player={best_Left_Defender1} />
                            </div>
                            <div className='col-3'>
                        ...
                        <div className='col-12 goalkeeper4_3_3'>
                            <div className='offset-4 col-4'>
                                <Player player={best_Goalkeeper1} />
                            </div>
                        </div>
...

            {
                ...
                <div className='container-fluid'>
                    ...
                    <div class="col-6 pitch">
                        ...
                        <div className='col-12 midfielders4_2_4'>
                            <div className='offset-3 col-3 '>
                                <Player player={best_Midfielder2} />
                            </div>
                            <div className='col-3'>
                        ...
                        <div className='col-12 defenders4_2_4'>
                            <div className='col-3'>
                                <Player player={best_Left_Defender1} />
                            </div>
                            <div className='col-3'>
                        ...
                        <div className='col-12 goalkeeper4_2_4'>
                            <div className='offset-4 col-4'>
                                <Player player={best_Goalkeeper1} />
                            </div>
                        </div>
